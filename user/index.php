...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-warning sticky-md-top">
    ...
    <div class="border border-dark my-3">
        <div class="my-2 fs-4"><b>Asfani</b></div>
        <img src="images_post/aglaonema-super-white.jpg" style="width: 250px;"><br>
        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Explicabo qui illo harum repellendus similique rerum ea provident nihil tempora, repudiandae itaque veritatis, voluptatibus blanditiis beatae? Accusamus perferendis autem error asperiores!</p>
        <div class="my-3">
    ...
    <div class="border border-dark my-3">
        <div class="my-2 fs-4"><b>Asfani</b></div>
        <img src="images_post/B-Bianco-Phanes.jpg" style="width: 250px;"><br>
        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Explicabo qui illo harum repellendus similique rerum ea provident nihil tempora, repudiandae itaque veritatis, voluptatibus blanditiis beatae? Accusamus perferendis autem error asperiores!</p>
        <div class="my-3">
        <button type="button" class="btn btn-outline-danger">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
    ...
    <div class="border border-dark my-3">
        <div class="my-2 fs-4"><b>Asfani</b></div>
        <img src="images_post/Merdeka_Square_Monas_02.jpg" style="width: 250px;"><br>
        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Explicabo qui illo harum repellendus similique rerum ea provident nihil tempora, repudiandae itaque veritatis, voluptatibus blanditiis beatae? Accusamus perferendis autem error asperiores!</p>
        <div class="my-3">
        <button type="button" class="btn btn-outline-danger">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
