...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-warning sticky-md-top">
    ...
    <h1 class="text-center py-3">Beranda</h1>
    <div class="float-left w-50 rounded-3 border border-primary">
    ...
    <div class="float-left w-25 rounded-3 border border-primary">
        <div class="mb-3 row mx-auto w-75">
            <label for="staticEmail" class="col-sm-5 col-form-label">Username</label>
            <div class="col-sm-7">
            <input type="text" class="form-control" id="Username">
